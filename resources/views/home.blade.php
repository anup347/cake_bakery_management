            ...
            <div
                ...
                <div class="flex flex-col items-center w-full lg:flex-row lg:w-1/2">
                    ...
                    <div class="max-w-lg lg:mx-12 lg:order-2">
                        <h1 class="text-3xl font-medium tracking-wide text-gray-800 dark:text-white lg:text-4xl">The best
                            cakes in town</h1>
                        ...
                        @guest
                            <div class="mt-6">
                                <a href="{{ route('register') }}"
                                    class="block px-3 py-2 font-semibold text-center text-white transition-colors duration-200 transform bg-blue-500 rounded-md lg:inline hover:bg-blue-400">Register to order
                                    your cake now!</a>
                            </div>
                        @endguest
                ...
                <div class="flex items-center justify-center w-full h-96 lg:w-1/2">
                    <img class="object-cover w-full h-full max-w-2xl rounded-md" src="{{ asset('layoutimg/home.jpg') }}"
